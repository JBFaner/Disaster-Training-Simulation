            ...
            <section class="content">
                ...
                <div class="quick-actions-section">
                    ...
                    <div class="quick-actions">
                        <a href="part-training-modules.php" class="quick-action-card">
                            <div class="action-icon">📖</div>
                            <h3>View Training Modules</h3>
                            <p>Learn disaster preparedness skills</p>
                            <span class="arrow">→</span>
                        </a>
                        <a href="part-my-events.php" class="quick-action-card">
                            <div class="action-icon">📅</div>
                            <h3>Register for Events</h3>
                            <p>Join upcoming simulation drills</p>
                            <span class="arrow">→</span>
                        </a>
                        <a href="part-evaluation-results.php" class="quick-action-card">
                            <div class="action-icon">📊</div>
                            <h3>View Results</h3>
                            <p>Check your evaluation scores</p>
                            <span class="arrow">→</span>
                        </a>
                        <a href="part-certificate.php" class="quick-action-card">
                            <div class="action-icon">🏆</div>
                ...
                <div class="upcoming-section">
                    ...
                    <div class="upcoming-events">
                        <div class="event-card">
                            ...
                            <a href="part-my-events.php" class="btn-event-action">Register →</a>
                        </div>
                        <div class="event-card">
                            <div class="event-date">
                                <span class="month">DEC</span>
